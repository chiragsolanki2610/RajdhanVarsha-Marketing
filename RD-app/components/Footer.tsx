          ...
          <div className="hidden md:grid grid-cols-4 gap-10 mb-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4 mt-2">
                ...
                <a href="https://www.instagram.com/rajdhanvarsha?utm_source=qr&igsh=MWgzYnh4M3gweW95dg==" aria-label="Instagram" className="text-white/60 hover:text-white transition-colors">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-extrabold text-base mb-5 tracking-wide">
                Quick Links
              </h4>
