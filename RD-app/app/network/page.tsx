...
export default function MobileNetworkHub() {
  const options = [
    { icon: UserPlus, label: 'Team Detail', desc: 'View direct downline matrix records', path: '/team-detail', color: 'bg-emerald-50 text-emerald-600' },
  ...
  return (
    <div className="flex min-h-screen w-full overflow-x-hidden bg-gray-50">
      ...
      <div className="flex flex-1 flex-col overflow-x-hidden">
        {/* Top bar */}
        <LoginTopbar pageTitle="My Network" />
