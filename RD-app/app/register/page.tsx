...
export default function RegisterPage() {
    ...
    const fetchSponsorName = async (sponsorId: string) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:56188/api/Auth/sponsor-lookup/${sponsorId.trim()}`, {
                method: "GET",
                headers: {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:56188/api/Auth/register", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleLoginAndRedirect = async () => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:56188/api/Auth/login", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
