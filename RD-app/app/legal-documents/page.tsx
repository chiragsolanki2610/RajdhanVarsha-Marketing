      ...
      <main className="flex-grow max-w-5xl w-full mx-auto px-4 pt-24 pb-12 md:pb-16">
        ...
        <div className="space-y-4">
          ...
          <DocumentRow
            ...
            onViewClick={() =>
              openModal('USYAM REGISTRATION CERTIFICATE', '/legalDocuments/rc-certificate.jpg')
            }
            icon={
          ...
          <DocumentRow
            ...
            onViewClick={() =>
              openModal('TRADEMARK CERTIFICATE', '/legalDocuments/Registeration of Trademark.jpg')
            }
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <DocumentRow
            ...
            onViewClick={() =>
              openModal('FOOD & DRUG CERTIFICATE', '/legalDocuments/Food & Drug Certificate.jpg')
            }
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <DocumentRow
            ...
            onViewClick={() =>
              openModal('REGISTRATION CERTIFICATE', '/legalDocuments/Rejisteration_Certificate.jpg')
            }
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
