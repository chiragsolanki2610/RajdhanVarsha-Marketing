...
public class AppDbContext : DbContext
{
    ...
    public DbSet<PickupCenterRequest> PickupCenterRequests => Set<PickupCenterRequest>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PickupCenterRequest>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Status).HasDefaultValue("Pending");
            entity.Property(e => e.SubmittedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
        ...
        modelBuilder.Entity<PickupCenter>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Status).HasDefaultValue("Active");
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("CURRENT_TIMESTAMP");
            entity.HasIndex(e => e.PucId).IsUnique();
            entity.HasIndex(e => e.Username).IsUnique();
        });

        modelBuilder.Entity<PickupCenterOrder>(entity =>
        {
            entity.HasKey(e => e.Id);
        ...
        modelBuilder.Entity<PickupCenterInventoryItem>(entity =>
        {
            entity.HasKey(e => e.Id);
