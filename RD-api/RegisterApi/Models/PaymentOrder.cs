...
public class PaymentOrder
{
    ...
    // Set only when this order was an instant, no-approval sale made in person by a
    // Pickup Center operator (SellPage) rather than a self-service user checkout.
    // Null for every normal order. Used purely for traceability / reporting.
    public string? SoldByPucId { get; set; }
