...
namespace RegisterApi.Migrations
{
    ...
    [Migration("20260625101214_AddBinaryPlan")]
    partial class AddBinaryPlan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RegisterApi.Models.BinaryNode", b =>
                {
                    ...
                    b.ToTable("BinaryNodes", (string)null);
                });
            ...
            modelBuilder.Entity("RegisterApi.Models.BinaryPair", b =>
                {
                    ...
                    b.ToTable("BinaryPairs", (string)null);
                });
            ...
            modelBuilder.Entity("RegisterApi.Models.BinaryWallet", b =>
                {
                    ...
                    b.ToTable("BinaryWallets", (string)null);
                });
            ...
            modelBuilder.Entity("RegisterApi.Models.BinaryWalletTransaction", b =>
                {
                    ...
                    b.ToTable("BinaryWalletTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("RegisterApi.Models.BinaryWithdrawalRequest", b =>
                {
                    ...
                    b.ToTable("BinaryWithdrawalRequests", (string)null);
                });
