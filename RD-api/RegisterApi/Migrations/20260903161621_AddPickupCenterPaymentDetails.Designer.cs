...
namespace RegisterApi.Migrations
{
    ...
    [Migration("20260903161621_AddPickupCenterPaymentDetails")]
    partial class AddPickupCenterPaymentDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegisterApi.Models.PickupCenter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("AadharImageBase64")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PanImageBase64")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PassbookImageBase64")
                        .HasColumnType("text");
                    ...
                    b.ToTable("PickupCenters");
                });

            modelBuilder.Entity("RegisterApi.Models.PickupCenterInventoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PickupCenterId", "ProductId")
                        .IsUnique();

                    b.ToTable("PickupCenterInventoryItems");
                });

            modelBuilder.Entity("RegisterApi.Models.PickupCenterOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PickupCenterId");

                    b.HasIndex("Status");

                    b.ToTable("PickupCenterOrders");
                });

            modelBuilder.Entity("RegisterApi.Models.PickupCenterRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("GeneratedPucId")
                        .HasColumnType("text");
                    ...
                    b.ToTable("PickupCenterRequests");
                });
